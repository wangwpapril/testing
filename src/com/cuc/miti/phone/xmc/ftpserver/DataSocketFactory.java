...
import com.cuc.miti.phone.xmc.domain.MyLog;
...
abstract public class DataSocketFactory {
    ...
    /**
     * When SwiFTP receives a PASV command, this will be called. Subclasses should perform
     * whatever initialization is necessary.
     * 
     * @return Whether the necessary actions completed successfully
     */
    ...
    /**
     * When it's time for data transfer to begin, the SessionThread will call this method
     * to perform any necessary actions to prepare the Socket for use and return it in a
     * state that's ready for reading or writing.
     * 
     ...
     * should use to connect it's data socket.
     */
    abstract public InetAddress getPasvIp();

    /**
     * We sometimes want to track the total number of bytes that go over the command and
